...
export default function AboutPage() {
  return (
    <article className="max-w-[76ch] mx-auto space-y-8 animate-fade-in py-2">
      ...
      {/* Creator Profile */}
      <section className="p-5 rounded-lg bg-surface border border-border space-y-4">
        <div className="flex items-center justify-between border-b border-border pb-3">
          <div className="flex items-center gap-2 text-text-primary">
            <User className="w-4 h-4 text-accent" />
            <h2 className="font-sans text-sm font-semibold">Creator & Maintainer</h2>
          </div>
          <span className="text-[11px] font-mono text-text-muted bg-surface-elevated px-2 py-0.5 rounded border border-border">
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-surface-elevated hover:bg-border border border-border text-xs font-mono text-text-primary hover:text-accent transition-colors"
            >
      ...
      {/* Credits */}
      <section className="p-4 rounded-lg bg-surface border border-border space-y-2">
        <div className="flex items-center gap-2 text-accent">
      ...
      {/* Maintainer Footer */}
      <footer className="pt-6 border-t border-border flex items-center justify-between text-xs font-mono text-text-muted">
